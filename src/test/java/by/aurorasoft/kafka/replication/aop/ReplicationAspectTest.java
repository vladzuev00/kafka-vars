...
import by.aurorasoft.kafka.replication.aop.ReplicationAspect.NoReplicationProducerException;
...
public final class ReplicationAspectTest extends AbstractSpringBootTest {
    ...
    @MockBean
    private KafkaProducerReplicationHolder mockedProducerHolder;
    ...
    public void saveShouldBeReplicated() {
        ...
        when(mockedProducerHolder.findByService(same(unProxy(service, TestCRUDService.class))))
    ...
    public void saveShouldNotBeReplicatedBecauseOfNoReplicationProducerForService() {
        ...
        when(mockedProducerHolder.findByService(same(unProxy(service, TestCRUDService.class)))).thenReturn(empty());
